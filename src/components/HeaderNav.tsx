...
import { Compass, ShieldCheck, BookOpen, DollarSign, Globe, Award, Sparkles, FileText, Camera, WifiOff, Lock } from 'lucide-react';
...
export const HeaderNav: React.FC<HeaderNavProps> = ({
  ...
  return (
    <header className="sticky top-0 z-50 bg-[#0b0b0c]/90 backdrop-blur-md border-b border-[#e9e3d6]/15 transition-all">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-20">
          ...
          <div className="flex items-center gap-4 cursor-pointer" onClick={() => setActiveTab('hero')}>
            ...
            <div>
              <div className="font-mono text-xs tracking-[0.22em] text-[#e9e3d6] uppercase font-bold flex items-center gap-1.5">
                theindiaproject<span className="text-[#c2a15a]">.world</span>
              </div>
              <div className="text-[10px] font-mono tracking-widest text-[#a49d8d] uppercase">
          ...
          {/* Traveler Type & Currency Selector Controls */}
          <div className="flex items-center gap-2.5">
            ...
            <button
              ...
              className="hidden sm:flex items-center gap-1 bg-[#111114] border border-[#c2a15a]/40 text-[#c2a15a] hover:bg-[#c2a15a]/10 px-2.5 py-1 rounded font-mono text-[10px] uppercase tracking-wider"
            ...
            <button
              ...
              className="bg-[#7c2427]/80 hover:bg-[#7c2427] text-[#e9e3d6] text-[10px] font-mono tracking-widest uppercase px-3 py-1.5 rounded border border-[#7c2427] transition-all shadow-sm"
            >
              Desk Card
            </button>
          </div>
