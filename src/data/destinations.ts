...
export const NEW_FOUND_DESTINATIONS: Destination[] = [
  {
    ...
    hosts: [
      ...
      },
      {
        ...
        story: "Teaches solo travelers zero-chemical paddy cultivation and bamboo fish trapping.",
  ...
  },
  {
    ...
    hosts: [
      ...
      },
      {
        ...
        story: "Spoti native with 15 years tracking high-altitude fauna and assisting solo photographers.",
